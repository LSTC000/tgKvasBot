...
from data.callbacks import BUYER_CHANGE_CITY_DATA, CANCEL_TO_MAIN_MENU_DATA

from data.messages import BUYER_CHANGE_CITY_IKB_MESSAGE, CANCEL_TO_MAIN_MENU_IKB_MESSAGE
